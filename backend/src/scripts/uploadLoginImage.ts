...
async function uploadLoginImage() {
  try {
    ...
    const possiblePaths = [
      path.join(__dirname, '../../uploads/portrait-professional-elegant-businessman.jpg'),
      path.join(process.cwd(), 'uploads/portrait-professional-elegant-businessman.jpg'),
      path.join(process.cwd(), '../uploads/portrait-professional-elegant-businessman.jpg'),
    ];
    ...
    // Upload to OVHcloud with key: login-page/portrait-professional-elegant-businessman.jpg
    const key = 'login-page/portrait-professional-elegant-businessman.jpg';
