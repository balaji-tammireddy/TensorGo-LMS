...
async function updateCasualLeaveForIntern() {
    ...
    `);
        ...
        // Annual Credit: 6.00
        // Carry Forward Limit: 0.00
        // Max Monthly Limit: 10.00
        // 3-Year Anniversary Bonus: 0.00
        // 5-Year Anniversary Bonus: 0.00
        ...
        const config = {
            ...
            anniversary_3_year_bonus: 0.00,
            anniversary_5_year_bonus: 0.00,
            effective_from: '2024-08-19'
        };

        console.log('\nUpdating Casual Leave configuration for intern...');
    ...
    `, [
        ...
        if (result.rows.length > 0) {
            ...
            console.log(`⚠️  No configuration found for intern`);
        }

        await client.query('COMMIT');
        console.log('\n✅ Successfully updated Casual Leave for Intern!');
      ...
      WHERE lt.code = 'casual' AND lpc.role = 'intern'
    `);

        console.log('\nUpdated Casual Leave configuration for Intern:');
